...
export default function Navbar() {
  ...
  return (
    <>
      ...
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      className="fixed top-10 md:top-12 left-0 right-0 z-40 px-6 md:px-6 py-2 md:py-4"
    >
      <div className="max-w-7xl mx-auto glass rounded-full px-4 md:px-6 py-2 md:py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1 md:gap-4">
          ...
          <button 
            onClick={toggleTheme}
            className="hidden md:flex p-1.5 md:p-2 hover:bg-primary/10 rounded-full transition-colors"
